...
namespace CloudFace.Renderers
{
	public class ShapeRenderer : VisualElementRenderer<ShapeView>
	{
		...
		protected virtual void HandleStandardDraw (CGContext currentContext, CGRect rect, Action createPathForShape, float? lineWidth = null)
		{
